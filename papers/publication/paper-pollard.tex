...
Lifeng Nai et al.~\cite{Nai:2016:architectural} provide a detailed performance analysis using GraphBIG as their reference implementation, profile Intel hardware counters, and measure the bottlenecks to measure scalability, computational efficiency for a variety of datasets.
...
\section{Methodology}
Automation of the installation\todo{This is sort of done in the repository, but not really explained in the paper}, configuration, and dataset conversion to ensure the experiments execute in the same manner.
