...
\todo{redo this table}
\begin{table}
	\caption{The dataset used is the same Kronecker graph with scale $22$ as used in other experiments. Performance results are in seconds with 32 threads. Community detection is performed using label propagation.}
	\centering
	\pgfplotstabletypeset[
	col sep=comma,
