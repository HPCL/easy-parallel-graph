...
%		System & \begin{tabular}[x]{@{}c@{}}Construct Data \\ Structure\end{tabular} & Run BFS & Run SSSP \\ \hline
%		PowerGraph & N/A & 0.003380 \\
%		GAP        & 0.412 & 0.001393 \\
%		GraphMat   &  & 0.1031 \\
%		GraphBIG   & N/A & 0.1528 \\
%	\end{tabular}
%	\caption{This table shows times for the Dota-League dataset using our method.}
%	\label{tab:epg-perf}
%\end{table}
