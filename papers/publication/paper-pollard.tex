...
Furthermore, the logarithmic scale in Figs.~\ref{fig:pr} and~\ref{fig:bfs-time} belies the actual variance in results. Each platform in Fig.~\ref{fig:pr} has a standard deviation comparable to that of 
...
\begin{figure}
	...
	\end{minipage}
	\caption{The top figure has both axes logarithmic. Linear speedup is. GraphMat dips below 1 because it is slower for $2$ threads than for 1.}
