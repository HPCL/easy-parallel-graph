...
\begin{table}
	\caption{A tabulated sample run of Graphalytics with 32 threads. Just one run per experiment is performed. Runtimes are in seconds. Below the table is an excerpt from the GraphMat log file.}
	\centering
