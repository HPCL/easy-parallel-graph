...
The following figures are not useful. They were are merely placeholders while further experiments are being run using the correct number of threads and roots. These issues are especially noticeable in GraphBIG.
\begin{table}[!htb]
	\centering
	\begin{tabular}{l|c|c|c}
...
\begin{figure}
	...
	\vspace{-18pt}
	\caption{The $y$-axis \emph{not} logarithmic. GraphMat iterations are measured differently because of the ``think like a vertex'' paradigm and runs unitl none of the vertices' ranks change.}
	\label{fig:pr-iters}
\end{figure}
